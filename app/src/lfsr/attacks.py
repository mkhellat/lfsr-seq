...
try:
    ...
    class _NormFallback:
        ...
        def ppf(p):
            ...
            (inverse CDF) using Peter Acklam's rational approximation.
            Python's stdlib math module has erf() but no erfinv(), so the
            closed-form erfinv-based formula cannot be used here."""
            if p <= 0.0 or p >= 1.0:
