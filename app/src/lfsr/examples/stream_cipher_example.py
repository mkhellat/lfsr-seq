...
from lfsr.ciphers import A5_1, E0, LILI128, Grain128, Grain128a, Trivium
...
def example_trivium():
    ...
    print(f"  Key size: {config.key_size} bits")
    print(f"  IV size: {config.iv_size} bits")
    print("  Note: Trivium uses shift registers with non-linear feedback")
...
def example_lili128():
    ...
    print(f"  Name: {config.cipher_name}")
    print(f"  Key size: {config.key_size} bits")
    print("  Note: Demonstrates clock-controlled LFSR design")
