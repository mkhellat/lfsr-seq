...
class TestSageImportGuardOptimization:
    """Regression coverage for the module-level
    `try: from sage.all import * / except ImportError: print(...);
    sys.exit(1)` guard in lfsr.examples.optimization_example (source lines near the
    ...
    def test_missing_sage_all_prints_error_and_exits(self, capsys):
        ...
        modname = "lfsr.examples.optimization_example"
