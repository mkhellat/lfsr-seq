...
def generate_report(
    ...
    report.append("- **Algorithm**: enumeration")
    report.append("- **Period-Only Mode**: Yes")
    ...
    if speedup < 1.0:
        ...
        report.append("3. **IPC Overhead**: Data serialization/deserialization between processes")
        report.append("4. **Cycles Spanning Chunks**: Workers may process overlapping cycles")
        report.append("")
    else:
    ...
    if speedup < 1.0:
        ...
        report.append("- Optimize IPC (currently significant overhead)")
