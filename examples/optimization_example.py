...
def example_period_via_factorization():
    ...
    if period is not None:
        ...
        print("  This method is much faster than enumeration for large LFSRs!")
    else:
        print("  ✗ Factorization failed, fall back to enumeration")
    ...
    if large_period is not None:
        ...
        print("  Factorization handles large LFSRs efficiently!")
    else:
