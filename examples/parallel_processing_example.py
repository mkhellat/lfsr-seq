...
def example_period_only_mode():
    ...
    print("This is because full sequence mode causes workers to hang due to")
    print("SageMath/multiprocessing interaction issues.")
    ...
    print("  Note: Sequence lists are empty in period-only mode")
    print("        (periods are computed but sequences not stored)")
...
def example_auto_detection():
    ...
    print("  - State space size > 10,000 states")
    print("  - Multiple CPU cores available (>= 2)")
    print("  - --parallel flag is not explicitly disabled")

    print("\nYou can also explicitly control parallel processing:")
    print("  --parallel        : Force parallel processing")
    print("  --no-parallel    : Force sequential processing")
    print("  --num-workers N  : Set number of workers")
