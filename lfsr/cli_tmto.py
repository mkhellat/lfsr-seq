...
def perform_tmto_attack_cli(
    ...
    print("TMTO Parameters:", file=output_file)
    ...
    if target_state is None:
        ...
        print("  (In practice, target state would come from observed keystream)", file=output_file)
    else:
    ...
    if table_file:
        ...
        try:
            ...
            print("  Generating new table instead...", file=output_file)
    ...
    if result.attack_successful:
        ...
        print("    (Target state may not be in table coverage)", file=output_file)
