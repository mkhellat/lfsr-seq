...
from lfsr.analysis import _find_period_enumeration, _find_period_floyd
...
def analyze_operation_count(start_state: Any, state_update_matrix: Any, period: int):
    ...
    print("Floyd estimated operations:")
    ...
    if period < 50:
        print("    Enumeration is better (small period, Floyd overhead dominates)")
    elif period < 200:
        print("    Close call - depends on implementation details")
    else:
        print("    Floyd might be better for very large periods")
